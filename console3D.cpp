...
int main()
{
	...
	while (true)
	{
		...
		//zheng front
		drawTriangle(POS{ (int)v1[0].X, (int)v1[0].Y }, POS{ (int)v1[1].X, (int)v1[1].Y }, POS{ (int)v1[2].X, (int)v1[2].Y }, win, '*', F_WHITE | B_WHITE);
		drawTriangle(POS{ (int)v1[0].X, (int)v1[0].Y }, POS{ (int)v1[2].X, (int)v1[2].Y }, POS{ (int)v1[3].X, (int)v1[3].Y }, win, '*', F_WHITE | B_WHITE);
		//right
		drawTriangle(POS{ (int)v1[2].X, (int)v1[2].Y }, POS{ (int)v1[3].X, (int)v1[3].Y }, POS{ (int)v1[6].X, (int)v1[6].Y }, win, '*', F_RED | B_RED);
		drawTriangle(POS{ (int)v1[2].X, (int)v1[2].Y }, POS{ (int)v1[6].X, (int)v1[6].Y }, POS{ (int)v1[7].X, (int)v1[7].Y }, win, '*', F_RED | B_RED);
		//back
		drawTriangle(POS{ (int)v1[4].X, (int)v1[4].Y }, POS{ (int)v1[6].X, (int)v1[6].Y }, POS{ (int)v1[5].X, (int)v1[5].Y }, win, '*', F_BLUE | B_BLUE);
		drawTriangle(POS{ (int)v1[4].X, (int)v1[4].Y }, POS{ (int)v1[7].X, (int)v1[7].Y }, POS{ (int)v1[6].X, (int)v1[6].Y }, win, '*', F_BLUE | B_BLUE);
		//left
		drawTriangle(POS{ (int)v1[4].X, (int)v1[4].Y }, POS{ (int)v1[5].X, (int)v1[5].Y }, POS{ (int)v1[1].X, (int)v1[1].Y }, win, '*', F_YELLOW | B_YELLOW);
		drawTriangle(POS{ (int)v1[4].X, (int)v1[4].Y }, POS{ (int)v1[1].X, (int)v1[1].Y }, POS{ (int)v1[0].X, (int)v1[0].Y }, win, '*', F_YELLOW | B_YELLOW);
		//top
		drawTriangle(POS{ (int)v1[4].X, (int)v1[4].Y }, POS{ (int)v1[1].X, (int)v1[1].Y }, POS{ (int)v1[0].X, (int)v1[0].Y }, win, '*', F_YELLOW | B_YELLOW);
		...
		wstring str = to_wstring(1.0 / t) + L"fps phi = " + to_wstring(phi);
